...
-- The caller's-rights connection is a separate session with no warehouse
-- selected; the app runs USE WAREHOUSE KS_WH on it. Allow the app to use the
-- caller's warehouse USAGE (the viewer holds it via the KS_SALES_* roles).
