...
GRANT USAGE ON WAREHOUSE KS_WH TO ROLE KS_APP_STAGING;
...
GRANT USAGE ON COMPUTE POOL SYSTEM_COMPUTE_POOL_CPU TO ROLE KS_APP_STAGING;
...
-- ---------------------------------------------------------------------------
GRANT DATABASE ROLE SNOWFLAKE.PYPI_REPOSITORY_USER TO ROLE KS_APP_STAGING;
